...
<form id="registro" name="registro" action="">
                    <table>
                    	<tr>
							<td colspan="2"><label>Agregar motivos de consulta</label></td>
                        </tr>
                        <tr>
                        	<td><label>Motivo:&nbsp;&nbsp;&nbsp;</label></td>
                            <td><input type="text" id="nuevo_motivo_consulta" name="nuevo_motivo_consulta"></td>
						</tr>
                        <tr>
                        	<td><label>Descripci&oacute;n:</label></td>
                        	<td><input type="text" name="nuevo_descripcion_motivo" id="nuevo_descripcion_motivo"></td>
                        </tr>
                        <tr>
                        	<td colspan="2">
                            <a class='enlace insertarmotivo' href='#'>&nbsp;Guardar&nbsp;</a>
                            </td>
                        </tr>
                     </table>
                     </form>
                     <div id="result_motivos" name="result_motivos"></div>
                        <br>
                        	<div class="mensaje_motivos"></div>
								<table class="editinplace_motivos" id="motivos" name="motivos">
									<tr>
										<th>ID.</th>
										<th>Motivo</th>
										<th>Descripción</th>
...
<script>
	$(document).ready(function() 
	{
		...
		$.ajax({
			type: "GET",
			url: "editinplace_motivos.php?tabla=1"
		})
		.done(function(json) {
			json = $.parseJSON(json)
			for(var i=0;i<json.length;i++)
			{
				$('.editinplace_motivos').append("<tr>"
											...
											+"<td class='editable' data-campo='motivo'><span>"+json[i].motivo+"</span></td>"
