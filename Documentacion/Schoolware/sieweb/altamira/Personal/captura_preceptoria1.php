...
$colorS=$_POST["color"];
/*echo" <script language='javascript'>alert('COLOR $colorS');</script>";*/
...
while($rst=mysql_fetch_array($sqlt))
	  {
		...
		$c.="<tr><td></td><td valign=top align=right rowspan=1000 style=\"font-family: Arial; font-weight: bold; font-size: 12pt;\"><br><br>";
...
while($rst=mysql_fetch_array($sqlt))
	  {
	  	$fecha=$rst['fecha'];
				...
				$c.="<br>
					...
					<img onClick=abrecalendario('fecha') src='../im/calendario.jpg' /><br><br>";
				}
