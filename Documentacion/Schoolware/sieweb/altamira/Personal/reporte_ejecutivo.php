...
<table  cellspacing='0' style='width: 100%; border: solid 2px #000000; font-size: 10pt'>
	<table  cellspacing='0' style='width: 100%; border: solid 2px #000000; font-size: 10pt'>		
		...
		<tr>
   			<td align='center' bgcolor='$baner'><b><font color='#FFFFFF'>Secci&oacute;n</font></b></td>
    		<td align='center' bgcolor='$baner'><b><font color='#FFFFFF'>No. Padres sin Entrevistas</font></b></td>
    		<td align='center' bgcolor='$baner'><b><font color='#FFFFFF'>% Secci&oacute;n</font></b></td>
  		</tr>";
...
for($y=1; $y<=3; $y++){						
	...
	while($seccion_nombre=mysql_fetch_array($seccion_)){
		...
		///Pantalla
    	$exportar.="<tr>
  						<td align='left' valign='center' bgcolor='$tr_par'>".$seccion_nombre['nombre']."</td>";
		////PDF
		$fpdf_exportar.="<tr>
  						<td align='left' valign='center' bgcolor='$tr_par'>".$seccion_nombre['nombre']."</td>";
...
if(empty($con_precep_) || empty($total_alumnos)) {
	$porcentaje_f_sin = 0;
} 
else {
...
<table  cellspacing='0' style='width: 100%; border: solid 2px #000000; font-size: 10pt '>
		...
		<tr>				
			<td align='center' bgcolor='$baner' colspan='2'><b><font color='#FFFFFF'>Secci&oacute;n</font></b></td>
    		<td align='center' bgcolor='$baner' colspan='6'><b><font color='#FFFFFF'>No. Alumnos sin Entrevistas</font></b></td>
    		<td align='center' bgcolor='$baner' colspan='2'><b><font color='#FFFFFF'>% Secci&oacute;n</font></b></td>
  		</tr>
					";
	////PDF
...
if(empty($total_con_precep) || empty($total_alum__)) {
	$porcent_sin = 0;
} 
else {
...
////Pantalla
$exportar.="		<td colspan='2' align='left' valign='center' bgcolor='$tr_par'>".$seccion_nombre__['nombre']."</td>";
///PDF
$fpdf_exportar.="		<td colspan='2' align='left' valign='center' bgcolor='$tr_par'>".$seccion_nombre__['nombre']."</td>";
  ...
  $exportar.="
	...
	$fpdf_exportar.="
  		<!--<tr>
			...
			<tr>
    			<td align='center' colspan='10'><a href='https://ecolmenares.net/sieweb/altamira/Personal/preceptorias.php' >Detalle reporte Alumnos sin preceptor&iacute;a </a></td>
  			</tr>
	</table>";    
...
<table  cellspacing='0' style='width: 100%; border: solid 2px #000000; text-align: left; font-size: 10pt'>
		...
		<tr>
			...
			<td align='center' colspan='5' bgcolor='$baner'><b><font color='#FFFFFF'>".$pmes." &nbsp;- &nbsp;" .$smes." </font> </b> </td>
			<td align='center' colspan='5' bgcolor='#FFFFFF'><b><font color='#00658A'>Semestre Actual</font> </b> </td>
		</tr>
		<tr>
			<td align='center' valign='top' bgcolor='$baner'><b><font color='#FFFFFF'>&nbsp;No. Alumnos por grupo&nbsp;</font></b></td>
			<td align='center' valign='top' bgcolor='$baner'><b><font color='#FFFFFF'>&nbsp;Asistencias Ambos&nbsp;</font></b></td>
			<td align='center' valign='top' bgcolor='$baner'><b><font color='#FFFFFF'>&nbsp;Asistencias Padre&nbsp;</font></b></td>
			<td align='center' valign='top' bgcolor='$baner'><b><font color='#FFFFFF'>&nbsp;Asistencias Madre&nbsp;</font></b></td>
			<td align='center' valign='top' bgcolor='$baner'><b><font color='#FFFFFF'>&nbsp;No Asisten Padres&nbsp;</font></b></td>
			<td align='center' valign='top' bgcolor='$baner'><b><font color='#FFFFFF'>&nbsp;Total Entrevistas&nbsp;</font></b></td>
			<td align='center' valing='top' bgcolor='$baner'><b><font color='#FFFFFF'>&nbsp;% Avance&nbsp;</font></b></td> 
		</tr>";
...
while($secc_=mysql_fetch_array($secc)){
	...
	$seccion_nombre=$secc_['nombre'];
		///Pantalla
		$exportar.="<tr><td colspan=8 align='center' valign='center' bgcolor='$fondo_n'><font color='#FFFFFF'>".$seccion_nombre."</font></td></tr>";
		////PDF
		$fpdf_exportar.="<tr><td colspan=8 align='center' valign='center' bgcolor='$fondo_n'><font color='#FFFFFF'>".$seccion_nombre."</font></td></tr>";
	////
	$sgg = mysql_query("select concat(seccion,grado,grupo) as sgg from grupos_sede where  ciclo=$preceptoriaCiclo and activo='S' and seccion=$seccion",$link);
		...
		/////Empezamos el query donde obtendremos el total de grupos y de alumnos por grupo vigentes (traemos la variable sgg)
		 $grup_grad=mysql_query("SELECT CONCAT(alumnos.grado,' ',alumnos.grupo) AS gg,						
				...
				////Pantalla
				$exportar.="<tr><td align='left' valign='top' bgcolor='$tr_par'><font color='#000000'>".$gg_['gg']."</font></td><td align='center'>".$gg_['total']."</td>";
				////PDF
				$fpdf_exportar.="<tr><td align='left' valign='top' bgcolor='$tr_par'><font color='#000000'>".$gg_['gg']."</font></td><td align='center'>".$gg_['total']."</td>";
				$a=$gg_['total'];
...
<table  cellspacing='0' style='width: 100%; border: solid 2px #000000; text-align: left; font-size: 10pt'>	
		...
		<tr>
			<td align='center' rowspan='2' valign='bottom'><b>Grupo</b></td>
			<td align='center' colspan='7' bgcolor='$baner'><b><font color='#FFFFFF'>".$p_pmes." </font> </b> </td>
			<!--<td align='center' colspan='6' bgcolor='#FFFFFF'><b><font color='$baner'>Mes Actual </font> </b> </td>-->
		...
		<tr>
			...
			<td align='center' valign='top' bgcolor='$baner'><b><font color='#FFFFFF'> No. Alumnos</font></b></td>
			<td colspan='3' align='center' valign='top' bgcolor='$baner'><b><font color='#FFFFFF'>% Avance</font></b></td>
			<td colspan='6' align='center' valign='top' bgcolor='$baner'><b><font color='#FFFFFF'>&nbsp;</font></b></td>
		</tr>";
...
while($secc_=mysql_fetch_array($secc)){
	...
	$seccion_nombre=$secc_['nombre'];
		///Pantalla
		$exportar.="<tr><td colspan='13' align='center' valign='center' bgcolor='$fondo_n'><font color='#FFFFFF'>".$seccion_nombre."</font></td></tr>";
		///PDF
		$fpdf_exportar.="<tr><td colspan='13' align='center' valign='center' bgcolor='$fondo_n'><font color='#FFFFFF'>".$seccion_nombre."</font></td></tr>";
	////
	$sgg = mysql_query("select concat(seccion,grado,grupo) as sgg from grupos_sede where  ciclo=$preceptoriaCiclo and activo='S' and seccion=$seccion",$link);
		...
		/////Empezamos el query donde obtendremos el total de grupos y de alumnos por grupo vigentes (traemos la variable sgg)
		 $grup_grad=mysql_query("SELECT CONCAT(alumnos.grado,' ',alumnos.grupo) AS gg,						
				...
				while($gg_=mysql_fetch_array($grup_grad)){							
				///Pantalla
				$exportar.="<tr><td align='left' valign='top' bgcolor='$tr_par'><font color='#000000'>".$gg_['gg']."</font></td>";
				///PDF
				$fpdf_exportar.="<tr><td align='left' valign='top' bgcolor='$tr_par'><font color='#000000'>".$gg_['gg']."</font></td>";
				$a=$gg_['total'];
