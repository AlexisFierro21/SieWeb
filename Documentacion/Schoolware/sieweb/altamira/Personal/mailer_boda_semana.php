...
$cuerpo.= '<h1> <center>Aniversarios de bodas de la semana.</center></h1>';
...
$cuerpo.= "<table width='800' border='2' cellspacing='2'>
      			<tr align='center' valign='middle'>
       	 			<th colspan='14'>Aniversarios de Bodas de la Semana</th>
      			</tr>
      			<tr align='center' valign='middle'>
						...
						FROM   
	 					...
	 					WHERE  
									...
									alumnos.activo='A' AND
									 TIMESTAMPDIFF(YEAR, fecha_boda, CURDATE()) < TIMESTAMPDIFF(YEAR, fecha_boda, ADDDATE(CURDATE(), 7))
						ORDER BY 
...
file_put_contents('BodaSemana.xls',utf8_decode($exportar));
file_put_contents('BodaSemana.txt',utf8_decode($exportar));


//// Ejecutamos el archivo de PHP para crear el pdf
include('pdf_boda_semana.php');  
...
$smtpPrefix="tls";
$smtpPort=587;
$mailSender="Aniversarios de la Semana, $n_escuela";
...
$mailPass="U926US<5gG";
		...
		$mail->IsHTML(true);
		$mail->AddAttachment('BodaSemana.xls', 'BodaSemana.xls');
		$mail->AddAttachment('BodaSemana.pdf', 'BodaSemana.pdf');
		$mail->Timeout=300;
		...
		$mail->Subject="Aniversarios de bodas de la semana, $n_escuela";
		$mail->Body=$cuerpo;
...
$dir='BodaSemana.pdf'; //puedes usar dobles comillas si quieres
if(file_exists($dir))
{
if(unlink($dir))
...
$dir='BodaSemana.txt'; //puedes usar dobles comillas si quieres
if(file_exists($dir))
{
if(unlink($dir))
print "<br>El archivo ".$dir." fue borrado";
