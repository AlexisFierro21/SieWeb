...
$fec_repo_i=' 18-08-2014 ';
$cuerpo.='Rango de fechas del: '.$f_m_inicial.' ';
$fechaf = '2015-01-15';
$fec_repo_f=' 15-01-2015 ';
$cuerpo.='Al: 15/01/2015 <br>'; 

$cuerpo.="
<table id='datatable' cellspacing='0' style='width: 80%; border: solid 2px #000000; font-size: 10pt'>
  <tr>
  	<td colspan='6' bgcolor='#D9B57B' align='center'><font color='#FFFFFF'><strong>Familias sin entrevistas realizadas (Semestral)</strong></font></td>
  </tr>
  <tr>
  	<th scope='col' bgcolor='#00658A' align='left'><font color='#FFFFFF'><strong>&nbsp;Alumno&nbsp;</strong></font></th>
	<th scope='col' bgcolor='#00658A' align='left'><font color='#FFFFFF'><strong>&nbsp;Nombre&nbsp;</strong></font></th> 
    <th scope='col' bgcolor='#00658A' align='left'><font color='#FFFFFF'><strong>&nbsp;Familia&nbsp;</strong></font></th>
	<th scope='col' bgcolor='#00658A' align='left'><font color='#FFFFFF'><strong>&nbsp;Secci&oacute;n&nbsp;</strong></font></th>
    <th scope='col' bgcolor='#00658A' align='left'><font color='#FFFFFF'><strong>&nbsp;Grado&nbsp;</strong></font></th>
	<th scope='col' bgcolor='#00658A' align='left'><font color='#FFFFFF'><strong>&nbsp;Preceptor&nbsp;</strong></font></th>
  </tr>";
...
$sprecep=mysql_query("SELECT DISTINCT alumnos.alumno AS alumno_,  
					...
					FROM alumnos, personal, secciones, familias 
						...
						AND not Exists(SELECT distinct(concat(alumnos.alumno,fec)) as totalA 
															...
															WHERE fec between '2014-08-18' and '2015-01-15'
...
while($row = mysql_fetch_array($sprecep))
                    {
					  ...
					  $cuerpo.="<td bgcolor='#FFFFCC'>&nbsp;".$row['seccion']."&nbsp;</td>";
	...
	$cuerpo.="<tr><td colspan='6' bgcolor='#D9B57B'><font color='#FFFFFF'><strong>Sin Entrevistas:</strong>&nbsp;&nbsp;$num_seccion&nbsp;</font></td></tr>";
