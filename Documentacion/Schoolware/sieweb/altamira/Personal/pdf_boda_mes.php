...
function Header()
   {
    ...
    $this->Cell(15);
    //Título
   $this->Cell(230,20,utf8_decode('Bodas del mes'),0,0,'C');
   $this->Ln(5);
...
$header = array('Nombre', 'Fecha', 'E-Mail', 'Telefono', 'Celular', 'Alumno', 'Escolaridad');
// Carga de datos
$data = $pdf->LoadData('BodaMes.txt');
$pdf->SetFont('Arial','',8);
//$pdf->AddPage();
...
$pdf->Output(utf8_decode("BodaMes.pdf"),"F");
